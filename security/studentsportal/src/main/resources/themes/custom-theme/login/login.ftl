                    ...
                    <form id="kc-form-login" onsubmit="login.disabled = true; return true;" action="${url.loginAction}"
                            ...
                            <div class="${properties.kcFormGroupClass!}">
                                ...
                                <div class="input-icon">
                                    ...
                                    <input tabindex="1" id="username"
                                           class="${properties.kcInputClass!} pf-c-form__label pf-c-form__label-text"
                                           name="username"
                        ...
                        <div class="${properties.kcFormGroupClass!}">
                            ...
                            <div class="input-icon">
                                ...
                                <input tabindex="2" id="password" placeholder="${msg("password")}"
                                       class="${properties.kcInputClass!} pf-c-form__label pf-c-form__label-text"
                                ...
                                <#if realm.rememberMe && !usernameHidden??>
                                    <div class="checkbox">
                                        <label class="remember-me">
                                            <#if login.rememberMe??>
                                                <input tabindex="3" id="rememberMe" class="remember-me-input" name="rememberMe" type="checkbox"
                                                       checked> ${msg("rememberMe")}
                                            <#else>
                                                <input tabindex="3" id="rememberMe" class="remember-me-input" name="rememberMe"
                        ...
                        <div id="kc-form-buttons" class="${properties.kcFormGroupClass!}">
                            ...
                            <#if realm.password && realm.registrationAllowed && !registrationDisabled??>
                                <div id="kc-registration-container">
                                    <div id="kc-registration">
                                         <a class="register-link" tabindex="6" href="${url.registrationUrl}">${msg("noAccount")}</a>
                                    </div>
                                </div>
                            </#if>
                            </div>
                            ...
                            <button name="login" id="kc-login" type="submit"
                                ...
                                <span class="login-msg">${msg("doLogIn")}</span>
