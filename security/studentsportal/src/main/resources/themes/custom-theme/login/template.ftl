            ...
            <div class="right">
                <header class="${properties.kcFormHeaderClass!}">
                    ...
                    <#if !(auth?has_content && auth.showUsername() && !auth.showResetCredentials())>
                        ...
                        <#else>
                            <div class="right-logo-container" style="display: none">
                                <img src="${url.resourcesPath}/img/logo.png" alt="logo" class=" logo-right">
                            </div>

                            <h1 class="kc-page-main-title">${kcSanitize(msg("loginTitleHtml",(realm.displayNameHtml!'')))?no_esc}</h1>
                            <h1 id="kc-page-title"><#nested "header"></h1>
                            <p class="login-description">Please fill your information below</p>
                        </#if>
                    <#else>
                        <#if displayRequiredFields>
                            <div class="${properties.kcContentWrapperClass!}">
